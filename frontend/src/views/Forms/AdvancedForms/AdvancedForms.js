              ...
              <CardBody>
                <FormGroup>
                  ...
                  <InputGroup>
                    ...
                    <TextMask mask={[/\d/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/]} Component={InputAdapter} className='form-control' />
                  </InputGroup>
                ...
                <FormGroup>
                  ...
                  <InputGroup>
                    ...
                    <TextMask mask={[/\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/, /\d/, /\d/, /\d/]} Component={InputAdapter} className='form-control' />
                  </InputGroup>
