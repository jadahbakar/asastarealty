...
const Register = props => {
  ...
  const [kotaList] = useHttp(`${backEndMaster}/kota/${state.propinsi}`, '', [])
  const [kecamatanList] = useHttp(`${backEndMaster}/kecamatan/${state.kota}`, '', [])
  const [KelurahanList] = useHttp(`${backEndMaster}/kelurahan/${state.kecamatan}`, '', [])
