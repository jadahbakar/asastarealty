            ...
            <div className='toolbar'>
              ...
              <ButtonDropdown isOpen={this.state.dropdownOpen} toggle={this.toggle}>
                ...
                <DropdownMenu>
                  <DropdownItem>
                    add label
                    <Badge color='danger'>Home</Badge>
                  </DropdownItem>
                  <DropdownItem>
                    add label
                    <Badge color='info'>Job</Badge>
                  </DropdownItem>
                  <DropdownItem>
                    add label
                    <Badge color='success'>Clients</Badge>
                  </DropdownItem>
                  <DropdownItem>
                    add label
